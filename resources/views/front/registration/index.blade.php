...
@section('content')
    ...
    <div class="col-md-12" id="register">
        ...
        {!! app('captcha')->display() !!}  <!-- Affiche le Google reCAPTCHA -->
        <span class="text-danger">{{ $errors->first('g-recaptcha-response') }}</span> <!-- Affiche l'erreur si le captcha est invalide -->
    </div>
                ...
                <!-- Inclure le script pour reCAPTCHA -->
